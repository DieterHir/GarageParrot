 ...
 */
class getGarageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GarageRepository' shared autowired service.
     *
     * @return \App\Repository\GarageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GarageRepository.php';

        return $container->privates['App\\Repository\\GarageRepository'] = new \App\Repository\GarageRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
