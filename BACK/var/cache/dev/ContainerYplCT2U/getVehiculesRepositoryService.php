 ...
 */
class getVehiculesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VehiculesRepository' shared autowired service.
     *
     * @return \App\Repository\VehiculesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VehiculesRepository.php';

        return $container->privates['App\\Repository\\VehiculesRepository'] = new \App\Repository\VehiculesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
