 ...
 */
class getTemoignagesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TemoignagesRepository' shared autowired service.
     *
     * @return \App\Repository\TemoignagesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TemoignagesRepository.php';

        return $container->privates['App\\Repository\\TemoignagesRepository'] = new \App\Repository\TemoignagesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
